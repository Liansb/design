...
public class DoubleCheck {
    ...
    public static void main(String[] args) {
        ...
        //双重检查创建实例比较
        DoubleCheck doubleCheckA = DoubleCheck.getDoubleCheck();
        DoubleCheck doubleCheckB = DoubleCheck.getDoubleCheck();
        System.out.println("双重检查创建实例比较：" + (doubleCheckA == doubleCheckB));
